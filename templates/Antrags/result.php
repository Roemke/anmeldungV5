...
<div id="idAntragSaved">
  ...
  <p>
    Ihre Daten sind nun bei uns gespeichert. <br>Sollten Sie Probleme mit dem Ausdruck haben,
...
</div> <!-- ende Antrag saved -->
<div id="idDruckBereich">
  <h1 id="idH1Aufnahme">
    Aufnahmeantrag Glasfachschule NRW, Zu den Fichten 19, 53359 Rheinbach
  </h1>
  ...
  <div id="idWeitereUnterlagen" class="noBreak">
    ...
    <?php endif; ?>
  </div> <!-- Ende div weitere Unterlagen -->
